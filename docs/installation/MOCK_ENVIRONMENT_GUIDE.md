...
> **ملاحظة تحقق:** هذا المستند يحتوي أمثلة تاريخية لبعض خدمات المحاكاة ومسارات إعداد مقترحة. لا تعتبر أي خدمة Mock موثقة أو مفعلة إلا بعد ربطها بملف كود حالي في مرحلة التكامل المختصة. المتغيرات العامة الموجودة في `.env.example` لا تثبت وحدها أن كل خدمة تستخدم Mock Mode.
