...
### ✅ آخر تحقق قابل لإعادة التشغيل (7 سبتمبر 2026)
- `pnpm check`: ناجح، 0 أخطاء TypeScript.
- `pnpm lint`: ناجح، 0 أخطاء و0 تحذيرات ESLint.
- `pnpm test`: ناجح، 164 ملف اختبار و1,249 حالة ناجحة.
- تم إصلاح مزامنة تعريفات الأدوار التي كانت تقرأ `id` فقط ثم تستخدم خصائص الصف الكامل.
- تم تثبيت اختبار لوحة الإدارة دون اعتماد tRPC Context حقيقي عبر mock للصلاحيات.
- تم تحديث اختبارات الترخيص للتحقق من الميزات وHardware ID الفعليين للترخيص الموقّع.
- تم إزالة تحذيرات ESLint المتبقية من اختبارات الأدوار والترخيص.
...
### 7 سبتمبر 2026
- ✅ إصلاح أخطاء TypeScript الأربعة في مزامنة تعريفات الأدوار.
- ✅ إصلاح حالات الاختبار الثلاث الفاشلة: لوحة الإدارة واختبارا الترخيص.
- ✅ تثبيت `pnpm test` كشرط CI؛ كان موجودًا أصلًا كـ job مطلوب قبل البناء.
- ✅ إزالة تحذيرات ESLint المتبقية.
- ✅ تحديث لقطة الجودة الحالية وربطها بالتقرير الإحصائي الشامل.
