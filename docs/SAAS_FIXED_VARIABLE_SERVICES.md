...
هذا الملف سيحتوي على شرح الخدمات الثابتة والمتغيرة في النظام.

## جدول المحتويات

1. قائمة الخدمات الثابتة
2. قائمة الخدمات المتغيرة
3. معايير التصنيف
4. كيفية الإدارة
...
**ملاحظة هامة:** بما أن النظام يستخدم قاعدة بيانات محلية (Standalone/Localized)، لا توجد قاعدة بيانات مركزية لإدارة الميزات. جميع الميزات تُقرأ من ملف license.json المحلي.
