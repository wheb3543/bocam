...
تستخدم منصة SGH CRM Portal قاعدة بيانات **MySQL/TiDB** مع 106 تعريفات جدول في `drizzle/schema.ts` عند آخر مراجعة. تم تصميم المخطط باستخدام **Drizzle ORM** لضمان النوعية والأمان. هذا المستند تاريخي ويحتاج تحديثًا تدريجيًا؛ المرجع الحالي هو [مرجع مخطط قاعدة البيانات الحالي](./DATABASE_SCHEMA_RUNTIME_REFERENCE.md).

### إحصائيات قاعدة البيانات

| المقياس | القيمة |
|---------|--------|
| **تعريفات الجداول في schema.ts** | 106 |
| **إجمالي الأعمدة** | 500+ |
| **الفهارس** | 50+ |
| **العلاقات الصريحة في relations.ts** | 2 مجموعات علاقات |
