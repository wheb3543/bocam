# دليل التراخيص والأمان الشامل | Comprehensive Licensing & Security Guide

هذا الدليل يدمج الدليل القانوني والدليل الفني لتراخيص منصة BOCAM CRM.

## 📋 جدول المحتويات
1. [الفصل القانوني والتراخيص (Legal Separation)](#الجزء-1-license_guidemd)
2. [نظام الترخيص المحلي المشفر (SaaS License System)](#الجزء-2-license_guidemd)

---

# الجزء 1: LICENSE_GUIDE.md
