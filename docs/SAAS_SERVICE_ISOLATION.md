...
هذا الملف سيحتوي على شرح كيفية فصل الخدمات المتغيرة لضمان عدم تأثيرها على الخدمات الأخرى.

## جدول المحتويات

1. استراتيجية الفصل
2. فصل الخدمات في Client-side
3. فصل الخدمات في Server-side
4. فصل الخدمات في قاعدة البيانات
5. اختبار العزل
...
- **Dependency Injection:** حقن التبعيات لتسهيل الاختبار والفصل
- **Middleware Layer:** استخدام Middleware للتحقق من الميزات قبل تنفيذ العمليات

**ملاحظة هامة:** بما أن النظام يستخدم معمارية Single-Tenant مع قاعدة بيانات محلية، لا يوجد عزل tenantId. العزل يتم فقط على مستوى الميزات (Feature-based Isolation).
