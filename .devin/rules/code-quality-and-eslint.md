...
# Lints & Code Style (ESLint)
- Adhere strictly to the project's ESLint configuration and architectural boundaries.
- Never bypass or disable ESLint rules (e.g., do not use 'eslint-disable' or 'any' types) unless explicitly approved.
...
- Before creating new logic, inspect the codebase to reuse existing utilities and components.
