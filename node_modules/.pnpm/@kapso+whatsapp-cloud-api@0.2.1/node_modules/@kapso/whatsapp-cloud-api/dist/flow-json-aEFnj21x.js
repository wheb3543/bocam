...
function initializeHashImplementation() {
	try {
		if (typeof createHash === "function") return (input) => createHash("sha256").update(input).digest("hex");
	} catch {
		return;
	}
}
...
//#endregion
export { computeFlowJsonHash, fromFlowJsonWireCase, fromWireKeyName, isPlainObject, toCamelCaseDeep, toFlowJsonWireCase, toSnakeCaseDeep };