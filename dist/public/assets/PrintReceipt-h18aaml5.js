import{A as r,C as c,a as m,g}from"./main-BBM8urqX.js";import{b as a,a as n}from"./vendor-date-Bn3KBNBU.js";function x(e,o){const t=window.open("","_blank","width=800,height=600");if(!t){alert("تعذر فتح نافذة الطباعة. الرجاء السماح بالنوافذ المنبثقة.");return}const s=new Date,p=e.receiptNumber||"قيد الإنشاء...",i={appointment:"موعد طبيب",camp:"تسجيل مخيم",offer:"حجز عرض"},l=`
    <div class="receipt">
      <div class="header">
        <img src="${r}" alt="${c}">
