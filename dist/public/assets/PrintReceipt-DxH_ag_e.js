import{A as r,C as c,a as m}from"./main-BnSWwDSD.js";import{b as a,a as n}from"./vendor-date-Bn3KBNBU.js";function w(e,o){const i=window.open("","_blank","width=800,height=600");if(!i){alert("تعذر فتح نافذة الطباعة. الرجاء السماح بالنوافذ المنبثقة.");return}const s=new Date,p=e.receiptNumber||"قيد الإنشاء...",t={appointment:"موعد طبيب",camp:"تسجيل مخيم",offer:"حجز عرض"},l=`
    <div class="receipt">
      <div class="header">
        <img src="${r}" alt="${c}">
  ...
  `;i.document.write(d),i.document.close()}export{w as p};
