...
import { assertRolePermission, permissionProcedure } from '../../../routers/permissionProcedures';
...
export const appointmentsRouter = router({
  ...
  getDoctorPublicSchedule: publicProcedure
    ...
    .query(async ({ input }) => {
      const { getDoctorPublicScheduleDetails } =
        await import('../../../services/schedulingService');
