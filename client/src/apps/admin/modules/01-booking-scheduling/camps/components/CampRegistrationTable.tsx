...
export default function CampRegistrationTable({
  ...
  const visibleColumnOrder = campTable.columnOrder.filter(
    (key) =>
      campTable.visibleColumns[key] &&
      (key !== 'checkbox' || canSelect) &&
      (key !== 'actions' || canUpdate || canDelete)
  );
    ...
    <div className="hidden md:block rounded-lg border bg-card">
      ...
      >
        ...
        <TableBody>
          {isLoading ? (
            <TableRow>
              <TableCell colSpan={visibleColumnOrder.length || 1} className="p-0">
            ...
            <TableRow>
              <TableCell colSpan={visibleColumnOrder.length || 1} className="py-12">
                        ...
                        <FrozenTableCell key={colKey} columnKey={colKey}>
                          <InlineStatusEditor
                            ...
                            onSave={async (newStatus) => {
                              ...
                              await _onUpdateStatus(reg.id, newStatus as CampStatus);
                            }}
                          />
                        </FrozenTableCell>
                      ) : (
