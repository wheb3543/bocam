...
import type { DateRange, SourceData, CampaignData } from '../bi/types/bi.types';
...
export default function BIPage() {
  ...
  const handleExportCSV = () => {
    ...
    const sourcesCSV = [
      ...
      ...sourceData.map((s: SourceData) => [s.source, s.total, s.conversions, s.rate + '%']),
    ]
      .map((row) => row.join(','))
      .join('\n');
    ...
    const campaignsCSV = [
      ...
      ...campaignData.map((c: CampaignData) => [
        c.campaign,
        c.source,
        c.sessions,
        c.conversions,
