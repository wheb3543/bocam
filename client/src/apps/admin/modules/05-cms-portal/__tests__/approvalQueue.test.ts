...
const dialogSource = readFileSync(
  resolve(process.cwd(), 'client/src/apps/admin/modules/05-cms-portal/components/dialogs/ApprovalQueueDialog.tsx'),
  'utf8'
);
...
const submissionHelperSource = readFileSync(
  resolve(process.cwd(), 'client/src/apps/admin/modules/05-cms-portal/utils/approvalSubmission.ts'),
  'utf8'
);
