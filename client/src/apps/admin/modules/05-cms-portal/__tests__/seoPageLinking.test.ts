...
const hookSource = readFileSync(
  resolve(process.cwd(), 'client/src/apps/admin/modules/05-cms-portal/hooks/useSEO.ts'),
  'utf8'
);
const dialogSource = readFileSync(
  resolve(process.cwd(), 'client/src/apps/admin/modules/05-cms-portal/components/dialogs/SEODialog.tsx'),
  'utf8'
);
const settingsSource = readFileSync(
  resolve(process.cwd(), 'client/src/apps/admin/modules/05-cms-portal/components/dialogs/PageSettingsDialog.tsx'),
  'utf8'
);
