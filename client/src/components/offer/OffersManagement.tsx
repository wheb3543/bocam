                ...
                {offerTable.visibleColumnOrder.map((colKey) => {
                  ...
                  return (
                    <ResizableHeaderCell
                      ...
                      columnKey={colKey}
                      width={
                        offerTable.columnWidths.columnWidths[colKey] || col.defaultWidth || 150
                      }
                      ...
                      case 'status':
                        return (
                          <FrozenTableCell key={colKey} columnKey={colKey}>
                            ...
                            >
                              <span
                                className={`inline-block w-1.5 h-1.5 rounded-full ml-1.5 ${offer.isActive ? 'bg-emerald-500' : 'bg-gray-400'}`}
                              />
