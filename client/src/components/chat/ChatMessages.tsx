  ...
  ({
    ...
    return (
      <div
        ...
        className="flex-1 space-y-3 overflow-y-auto bg-gray-50 p-2.5 sm:space-y-4 sm:p-4 dark:bg-gray-900"
        ...
        {Object.entries(groupedMessages).map(([dateKey, dateMessages]) => (
          <div key={dateKey}>
            ...
            <div className="my-3 flex justify-center sm:my-4">
              <span className="rounded-full bg-gray-200 px-3 py-1 text-xs text-gray-700 dark:bg-gray-700 dark:text-gray-300 sm:px-4 sm:text-sm">
