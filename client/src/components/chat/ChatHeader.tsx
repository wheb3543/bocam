...
export const ChatHeader = memo(
  ({
    ...
    return (
      <div className="hidden items-center justify-between border-b border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800 sm:flex">
        <div className="flex items-center gap-3">
          {isSelectionMode ? (
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium">{selectedMessagesCount} رسالة محددة</span>
              <Button
                variant="destructive"
                size="sm"
            ...
            <>
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">{phone || 'غير محدد'}</p>
              </div>
            </>
          )}
        </div>
        ...
        {!isSelectionMode && (
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="icon" onClick={onSearchOpen} title="بحث في المحادثة">
              <Search className="h-5 w-5" />
            </Button>

            <Button variant="ghost" size="icon" onClick={onMediaGalleryOpen} title="معرض الوسائط">
