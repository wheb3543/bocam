    ...
    <Card className="rounded-2xl shadow-sm">
      ...
      <CardContent className="space-y-3 text-sm">
        <div className="flex items-center justify-between">
          <span className="text-muted-foreground inline-flex items-center gap-1"><Calendar className="h-4 w-4" />التاريخ</span>
          <span>{formatDate(appointment.appointmentDate || appointment.createdAt)}</span>
        </div>
        {appointment.procedure && (
          <div className="flex items-center justify-between">
            <span className="text-muted-foreground inline-flex items-center gap-1"><Stethoscope className="h-4 w-4" />الإجراء</span>
            <span>{appointment.procedure}</span>
          </div>
        )}
        {appointment.phone && (
          <div className="flex items-center justify-between">
            <span className="text-muted-foreground inline-flex items-center gap-1"><Phone className="h-4 w-4" />الهاتف</span>
        ...
        {appointment.additionalNotes && (
          <div className="pt-2 border-t">
            <p className="text-muted-foreground inline-flex items-center gap-1 mb-1"><FileText className="h-4 w-4" />ملاحظات</p>
