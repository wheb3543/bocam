    ...
    <>
      ...
      >
        ...
        <section
          id="stats-section"
          data-scroll-reveal
          className="py-12 sm:py-16 md:py-20 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm relative opacity-0 transform translate-y-8 transition-all duration-700 ease-out"
          style={{
            opacity: visibleSections['stats-section'] ? 1 : 0,
            transform: visibleSections['stats-section'] ? 'translateY(0)' : 'translateY(32px)',
          }}
        >
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-wrap justify-center gap-6 sm:gap-8 md:gap-10">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="text-center p-6 sm:p-8 md:p-10 rounded-xl sm:rounded-2xl bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border-2 border-gray-200 dark:border-gray-700/50 hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-300 hover:scale-105 animate-card-appear cursor-pointer flex-1 min-w-[200px] sm:min-w-[250px]"
                  style={{ animationDelay: `${index * 0.15}s` }}
                >
                  <div
                    className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-lg sm:rounded-xl ${stat.bg} flex items-center justify-center mx-auto mb-4 sm:mb-5 animate-icon-bounce`}
                  >
                    <stat.icon className={`w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 ${stat.color}`} />
                  </div>
                  <div
                    className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold ${stat.color} mb-2 sm:mb-3`}
                  >
                    {stat.number}
                  </div>
                  <div className="text-sm sm:text-base md:text-lg lg:text-xl text-foreground dark:text-foreground font-semibold">
                    {stat.label}
                  </div>
                </div>
              ))}
        ...
        <section
          id="services-section"
          data-scroll-reveal
          className="py-12 sm:py-16 md:py-24 bg-muted/50 dark:bg-gray-950 relative opacity-0 transform translate-y-8 transition-all duration-700 ease-out"
          style={{
            opacity: visibleSections['services-section'] ? 1 : 0,
            transform: visibleSections['services-section'] ? 'translateY(0)' : 'translateY(32px)',
          }}
        >
          <div className="container mx-auto px-4 sm:px-6">
              ...
              {services.map((service, index) => (
                ...
                >
                  <CardHeader className="pb-4 sm:pb-5 md:pb-6 p-6 sm:p-7 md:p-8">
                    ...
                    >
                      <service.icon
                        className={`h-7 w-7 sm:h-9 sm:w-9 md:h-10 md:w-10 ${service.color}`}
                      />
                      <Sparkles
                        className={`absolute -top-1 -right-1 h-5 w-5 ${service.color} animate-sparkle`}
                      />
                    </div>
                    <CardTitle className="text-lg sm:text-xl md:text-2xl text-foreground dark:text-white text-right">
                      {service.title}
                    </CardTitle>
        ...
        <section
          id="about-section"
          data-scroll-reveal
          className="py-12 sm:py-16 md:py-24 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm relative opacity-0 transform translate-y-8 transition-all duration-700 ease-out"
          style={{
            opacity: visibleSections['about-section'] ? 1 : 0,
            transform: visibleSections['about-section'] ? 'translateY(0)' : 'translateY(32px)',
          }}
        >
          <div className="container mx-auto px-4 sm:px-6">
                ...
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <div className="text-right sm:text-center">
                      <h3 className="font-bold text-base sm:text-lg md:text-xl text-foreground dark:text-white mb-2 sm:mb-3">
                        {feature.title}
                      </h3>
                      <p className="text-sm sm:text-base md:text-lg text-muted-foreground dark:text-muted-foreground">
                        {feature.description}
                      </p>
                    </div>
                  </div>
        ...
        <section
          id="cta-section"
          data-scroll-reveal
          className="py-12 sm:py-16 md:py-24 bg-gradient-to-br from-green-600 via-green-700 to-blue-600 text-white overflow-hidden relative opacity-0 transform translate-y-8 transition-all duration-700 ease-out"
          style={{
            opacity: visibleSections['cta-section'] ? 1 : 0,
            transform: visibleSections['cta-section'] ? 'translateY(0)' : 'translateY(32px)',
          }}
        >
          {/* Animated Heart Effect */}
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
