          ...
          >
            ...
            <section>
              ...
              <p className="text-sm sm:text-base">
                يلتزم {companyName} بحماية خصوصيتك وصون بياناتك الشخصية وفقاً لأحكام نظام حماية
                البيانات الشخصية في المملكة العربية السعودية (PDPL) وأفضل الممارسات الدولية. تُوضّح
                هذه السياسة كيفية جمع بياناتك واستخدامها وتخزينها ومشاركتها، وكيف نضمن التعامل معها
                بمسؤولية وشفافية تامة.
              </p>
              <p className="text-sm sm:text-base mt-3">
                تنطبق هذه السياسة على جميع الخدمات الرقمية التي نقدمها، بما في ذلك موقعنا
                الإلكتروني، وتطبيق الجوال، وخدمات الحجز الإلكتروني، والتواصل عبر واتساب وفيسبوك
                وإنستغرام.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base mb-4">
                نجمع فقط البيانات الضرورية لتقديم خدماتنا الصحية وإدارة عملياتنا وتلبية المتطلبات
                القانونية والتنظيمية، وتشمل:
              </p>
              <div className="space-y-4">
                ...
                >
                  <h3 className="font-semibold text-green-800 text-sm sm:text-base mb-2">
                    أ. بيانات المريض والمستخدم
                  </h3>
                  <p className="text-sm">
                    الاسم الكامل، رقم الهاتف، البريد الإلكتروني، العمر، الجنس، والبيانات الصحية
                    الضرورية لتقديم الرعاية الطبية ومعالجة مطالبات التأمين.
                  </p>
                </AnimatedCard>
                <AnimatedCard className="bg-blue-50 rounded-lg p-4" delay={0.2} hoverEffect={false}>
                  <h3 className="font-semibold text-blue-800 text-sm sm:text-base mb-2">
                    ب. بيانات الخدمات الرقمية
                  </h3>
                  <p className="text-sm">
                    تفاصيل التسجيل عبر الإنترنت، بيانات الحجز والمواعيد، والتفاعلات عبر تطبيقاتنا
                    ومنصاتنا الرقمية.
                  </p>
                </AnimatedCard>
                <AnimatedCard
                  ...
                  hoverEffect={false}
                >
                  <h3 className="font-semibold text-purple-800 text-sm sm:text-base mb-2">
                    ج. بيانات التتبع والتحليل
                  </h3>
                  <p className="text-sm">
                    مصدر الزيارة (فيسبوك، واتساب، جوجل، أو مباشر)، مسار التنقل داخل الموقع، ومعلومات
                    الجهاز والمتصفح — وذلك بناءً على موافقتك فقط.
                  </p>
                </AnimatedCard>
                <AnimatedCard
                  ...
                  hoverEffect={false}
                >
                  <h3 className="font-semibold text-orange-800 text-sm sm:text-base mb-2">
                    د. مسودات النماذج غير المكتملة (Lead Recovery)
                  </h3>
                  <p className="text-sm">
                    في حال بدأت ملء نموذج حجز ولم تكمله، قد نحفظ البيانات المُدخلة مؤقتاً (رقم
                    الهاتف أو الاسم) للتواصل معك ومساعدتك في إتمام الحجز. يمكنك طلب حذف هذه البيانات
                    في أي وقت.
                  </p>
                </AnimatedCard>
              </div>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base">
                نجمع بياناتك من خلال وسائل آمنة وقانونية، تشمل: النماذج الإلكترونية وتطبيقات الجوال
                وبوابات المرضى، وأنظمة المعلومات الصحية والسجلات الطبية الإلكترونية، وملفات تعريف
                الارتباط (Cookies) عند استخدامك لموقعنا أو منصاتنا الرقمية، والتواصل المباشر عبر
                الهاتف أو واتساب أو وسائل التواصل الاجتماعي.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 sm:p-5">
                <p className="text-sm sm:text-base mb-3">
                  يستخدم {companyName} واجهة برمجة تطبيقات واتساب للأعمال المُقدَّمة من شركة Meta
                  Platforms, Inc. لأغراض التواصل مع المرضى والمستخدمين، وتشمل:
                </p>
                ...
                <p className="text-sm mt-3 text-gray-600">
                  <strong>ملاحظة:</strong> يُعالَج رقم هاتفك عبر خوادم Meta وفقاً لسياسة خصوصية Meta
                  المتاحة على{' '}
                  <a
                  ...
                  . يمكنك إلغاء الاشتراك في رسائل واتساب التسويقية في أي وقت بإرسال كلمة "إلغاء" أو
                  التواصل معنا مباشرة.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base mb-3">
                بموافقتك على ملفات تعريف الارتباط التسويقية، قد نستخدم تقنيات Meta (فيسبوك
                وإنستغرام) لأغراض قياس أداء الإعلانات وتحسين تجربتك، وتشمل:
              </p>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base">
                تُستخدم بياناتك لدعم الأنشطة الصحية والإدارية، وتشمل: تقديم الخدمات الطبية عالية
                الجودة والآمنة، وإدارة سجلات الموظفين والمستشفى، والوفاء بالالتزامات القانونية
                والتنظيمية، وضمان التواصل الفعّال وتنسيق الخدمات، وتحسين تجربة المستخدم على منصاتنا
                الرقمية، وإرسال تحديثات وعروض ذات صلة بخدماتنا (بموافقتك فقط).
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base mb-3">
                لا نبيع بياناتك الشخصية لأي طرف ثالث. نشارك البيانات فقط عند الضرورة ولأغراض مشروعة،
                تشمل:
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-green-600 font-bold mt-0.5">•</span>
                  <span>المختبرات والمرافق الطبية لأغراض التشخيص والعلاج.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 font-bold mt-0.5">•</span>
                  <span>شركات التأمين لمعالجة المطالبات والتسويات.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 font-bold mt-0.5">•</span>
                  <span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-600 font-bold mt-0.5">•</span>
                  <span>الجهات الحكومية عند الاقتضاء القانوني.</span>
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base mb-4">
                يستخدم موقعنا وتطبيقاتنا ملفات تعريف الارتباط لضمان التشغيل السلس وتحسين تجربتك.
                يمكنك إدارة تفضيلاتك عبر شريط الموافقة الذي يظهر عند زيارة الموقع لأول مرة.
              </p>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-200 p-2">
                        الإعلانات وإعادة الاستهداف (Meta Pixel)
                      </td>
                      <td className="border border-gray-200 p-2 text-orange-600">بموافقتك</td>
                    </tr>
                  </tbody>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base">
                يدعم موقعنا تقنية التطبيق التدريجي (Progressive Web App) التي تتيح لك تثبيته على
                جهازك والوصول إليه بدون إنترنت. لتحقيق ذلك، نستخدم التخزين المحلي (LocalStorage
                وIndexedDB وService Worker Cache) لحفظ بعض البيانات على جهازك، مثل تفضيلاتك وبيانات
                الحجوزات المؤقتة. هذه البيانات تبقى على جهازك فقط ولا تُرسل إلى خوادمنا إلا عند
            ...
            <section>
              ...
              <p className="text-sm sm:text-base mb-3">
                تُخزَّن بياناتك بصورة رئيسية داخل المملكة العربية السعودية. في حالات محدودة، قد
                تُعالَج خارج المملكة وفق ضمانات وعقود معتمدة بموجب نظام حماية البيانات الشخصية
                (PDPL).
              </p>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  {
                    title: 'سحب الموافقة',
                    desc: 'الحق في سحب موافقتك على المعالجة الاختيارية في أي وقت.',
                  },
                  {
                    title: 'التصحيح',
                    desc: 'الحق في تصحيح أو تحديث بياناتك غير الدقيقة أو الناقصة.',
                  },
                  {
                    title: 'نسخة من البيانات',
                    desc: 'الحق في الحصول على نسخة من بياناتك الشخصية.',
                  },
                ].map((right) => (
                  <div
                    key={right.title}
              ...
              <p className="text-sm mt-4 text-gray-600">
                ستُعالَج جميع الطلبات الصحيحة خلال 30 يوماً، مع إمكانية التمديد 30 يوماً إضافية عند
                الاقتضاء القانوني.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 sm:p-5">
                <p className="text-sm sm:text-base mb-3">يمكنك في أي وقت:</p>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-amber-600 font-bold mt-0.5">•</span>
                    <span>
                      إلغاء الاشتراك في رسائل البريد الإلكتروني التسويقية عبر رابط "إلغاء الاشتراك"
                      في أسفل كل رسالة.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
            ...
            <section>
              ...
              <p className="text-sm sm:text-base">
                نحرص على حماية خصوصية الأطفال. لا يمكن إنشاء حسابات إلا للأفراد الذين تجاوزوا سن
                الثامنة عشرة. بالنسبة للأطفال، يجب أن يُنشئ الحساب ويُدار من قِبل أحد الوالدين أو
                الأوصياء القانونيين.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base mb-4">
                إذا كنت ترغب في ممارسة أي من حقوقك المتعلقة بحماية البيانات، أو إذا كنت تعتقد أن
                بياناتك الشخصية قد تعرضت لسوء المعالجة، يمكنك التواصل مع مسؤول حماية البيانات في{' '}
                {companyName} :
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a
                  href="tel:+967734000018"
              ...
              <p className="text-sm mt-4 text-gray-600">
                إذا لم تكن راضياً عن ردنا خلال 30 يوماً، يمكنك تقديم شكوى إلى المركز الوطني
                للمعلومات (Yemen-NIC).
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base">
                قد نُحدّث هذه السياسة من وقت لآخر لتعكس التغييرات القانونية أو التشغيلية. ستكون
                النسخة الأحدث متاحة دائماً على موقعنا الرسمي. في حال إجراء تغييرات جوهرية، سنُخطرك
                عبر البريد الإلكتروني أو إشعار بارز على الموقع.
              </p>
              <p className="text-sm mt-3 text-gray-500">آخر تحديث لهذه السياسة: مارس 2026</p>
            </section>
          </AnimatedCard>
        </ScrollReveal>
      </main>
