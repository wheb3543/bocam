...
export default function ActivationPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 flex items-center justify-center p-4" dir="rtl">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-base">
            أدخل كود الترخيص لتفعيل النظام
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleActivation} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="licenseKey" className="text-base">كود الترخيص</Label>
              <Input
                id="licenseKey"
                type="text"
            ...
            <div className="pt-4 border-t">
              <div className="flex items-start gap-2 text-sm text-muted-foreground">
                ...
                <p className="text-xs">
                  تأكد من أن كود الترخيص صحيح ومخصص لهذا الجهاز. كود الترخيص مرتبط بمعرف الجهاز (Hardware ID).
                </p>
              </div>
            </div>
          </form>
