...
export default function OfflinePage() {
  ...
  return (
    <DashboardLayout pageTitle="العمل بدون اتصال" pageDescription="عرض البيانات المحفوظة محلياً">
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="secondary">{cachedAppointments.length} موعد</Badge>
                </div>
                {lastSync && <CardDescription>آخر مزامنة: {lastSync}</CardDescription>}
              </CardHeader>
              <CardContent>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    عند الاتصال بالإنترنت، يتم حفظ المواعيد تلقائياً على جهازك لعرضها عند عدم توفر
                    الاتصال. سيتم مزامنة أي تغييرات تقوم بها عند استعادة الاتصال.
                  </p>
                </div>
              </div>
            </CardContent>
