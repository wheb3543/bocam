...
const templates = [
  // 1. تأكيدات الحجوزات
  {
    ...
    variables: JSON.stringify(['name', 'doctor_name', 'specialty', 'date', 'time']),
...

  {
    ...
    variables: JSON.stringify(['name', 'offer_title', 'offer_details', 'expiry_date']),
...

  {
    ...
    variables: JSON.stringify(['name', 'offer_title', 'expiry_date', 'phone_number']),
